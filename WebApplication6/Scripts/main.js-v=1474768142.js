...
function mdTweetGetFreebie(){
  ...
  jQuery.ajax({ url: 'http://www.webdesignerdepot.com/widget/getMdFreebie.php', type : 'POST',
...
function otoFreebieExternalRequest(email, refID, code){
  ...
  jQuery.ajax({ url: 'http://www.webdesignerdepot.com/widget/subscribeOtoFreebie.php', type : 'POST',
     data: { refID : refID, Type: 3, code : code, email: email },
     success: function(responseText){
      var matches = /^file:(.*)/i.exec(responseText); 
    	if(responseText == 'error'){
...
function wddFreebieExternalRequest(email, refID, file){
  ...
  jQuery.ajax({ url: 'http://www.webdesignerdepot.com/widget/subscribeWddFreebie.php', type : 'POST',
...
function mdFreebieExternalRequest(email, refID, code){
  ...
  jQuery.ajax({ url: 'http://www.webdesignerdepot.com/widget/subscribeMdFreebie.php', type : 'POST',
     data: { refID : refID, Type: 3, code : code, email: email },
     success: function(responseText){
      var matches = /^file:(.*)/i.exec(responseText); 
    	if(responseText == 'error'){
...
function initBlog(){
  ...
  */
  ...
  for(var appIndex in wddAppsList){
     ...
     if(refVal == 'home'){
      option.attr('value', 'index.htm'/*tpa=http://www.webdesignerdepot.com/*/);
    }
    else{ 
...
function initControls(){
  ...
  jQuery('#main-menu-select').change(function(){
    ...
    if(val.indexOf('#') >= 0){
      window.location = 'http://www.webdesignerdepot.com/app/' + val;
    }
    else{
      window.location = val;
    }
...
function handlePlusShares(url, widget){
  ...
  var params = {
      ...
      gapi.client.rpcRequest('http://www.webdesignerdepot.com/app/js/pos.plusones.get', 'v1', params).execute(function(resp) {
